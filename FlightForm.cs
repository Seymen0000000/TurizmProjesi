...
namespace SkySea
{
    public partial class FlightForm : Form
    {
        ...
        {
            this.Text = LanguageManager.Instance.GetString("FlightsTitle");
            this.Size = new Size(900, 700);
            this.StartPosition = FormStartPosition.CenterScreen;

            Label lblTitle = new Label();
            lblTitle.Text = LanguageManager.Instance.GetString("Flights");
            ...
            btnBuy.Click += (s, e) =>
            {
                ...
                {
                    string flight = dataGridView.SelectedRows[0].Cells["kalkis"].Value.ToString() + " - " + dataGridView.SelectedRows[0].Cells["varis"].Value.ToString();
                    string price = dataGridView.SelectedRows[0].Cells["fiyat"].Value.ToString();
                    this.Hide();
                    new PaymentForm("Uçak Bileti", price).Show();
                    this.Opacity = 0;
                    this.Show();
                    this.Opacity = 1;
                }
